...
describe('src/http-proxy/passes/web.ts', function () {
    ...
    describe('#timeout', function () {
        it('should set timeout on the socket', function () {
            ...
            _timeout(stubRequest, {}, { timeout: 5000 });
...
describe('#httpProxy.createProxyServer.web() using own http server', function () {
